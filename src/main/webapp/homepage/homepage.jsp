                ...
                <table class="quizzes-table">
                    ...
                    <tbody>
                        <%
                            ...
                            List<Quiz> popQuizList =(List<Quiz>) request.getAttribute("PopularQuizList");
                            int counter = 1;
                            for(Quiz q : popQuizList){
                        %>
                            <tr><a href="SummaryPageServlet?quiz_id=<%= q.getQuizID() %>"><%= q.getQuizName() %></a></tr>
                        <%
                                counter++;
                            }
                        %>
